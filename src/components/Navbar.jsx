...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 w-full z-50 bg-black bg-opacity-70 text-white">
      <div className="flex justify-between items-center h-24 max-w-[1360px] mx-auto px-4">
        <h1 className="w-full text-3xl italic font-serif text-white">Ajeen</h1>
        ...
        <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'fixed left-[-100%]'}>
          <h1 className="w-full text-3xl font-bold text-[#00df9a] m-4">Ajeen.</h1>
